...
void main() {
  ...
  group(QueryApi, () {
    ...
    //
    //Future<PublicStayProviderList> queryListStayProviders({ String locationId, int minPrice, int maxPrice, int paxCount, BuiltList<String> amenities, num minRating, int limit, int offset }) async
