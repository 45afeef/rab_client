...
void main() {
  ...
  group(QueryApi, () {
    ...
    //
    //Future<PublicStayProviderList> queryListStayProviders({ String location, num lat, num lon, num radiusKm, int minPrice, int maxPrice, int paxCount, int roomCount, BuiltList<String> amenities, int limit, int offset }) async
