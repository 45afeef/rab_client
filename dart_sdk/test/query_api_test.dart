...
void main() {
  ...
  group(QueryApi, () {
    ...
    //
    //Future<BuiltMap<String, JsonObject>> queryListStayProviders({ String locationId, int minPrice, int maxPrice, int paxCount, BuiltList<String> amenities, num minRating, int limit, int offset }) async
    ...
    //
    //Future<UnitsList> queryListStayUnits({ String providerId, int minPrice, int maxPrice, int paxCount, BuiltList<String> amenities, int limit, int offset }) async
