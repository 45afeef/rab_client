...
class ProfileApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [ProfilePublic] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ProfilePublic>> profileCreateProfile({ 
    ...
    try {
      const _type = FullType(ProfileCreate);
      _bodyData = _serializers.serialize(profileCreate, specifiedType: _type);
    ...
    ProfilePublic? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(ProfilePublic),
      ) as ProfilePublic;
  ...
  /// Returns a [Future] containing a [Response] with a [ProfilePublic] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ProfilePublic>> profileReadProfiles({ 
    int? skip = 0,
    int? limit = 100,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Profile>> profileUpdateProfileById({ 
    ...
    final _path = r'/api/v1/profile/{profile_id}'.replaceAll('{' r'profile_id' '}', encodeQueryParameter(_serializers, profileId, const FullType(String)).toString());
    final _options = Options(
      method: r'PUT',
      headers: <String, dynamic>{
        ...?headers,
