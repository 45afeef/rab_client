...
class ProvidersStayApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [StayAmenity] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<StayAmenity>> providersStayAddAmenity({ 
    ...
    StayAmenity? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(StayAmenity),
      ) as StayAmenity;
