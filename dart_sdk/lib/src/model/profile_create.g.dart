...
class _$ProfileCreate extends ProfileCreate {
  @override
  ...
  @override
  ProfileCreateBuilder toBuilder() => ProfileCreateBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is ProfileCreate &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'ProfileCreate')
...
class ProfileCreateBuilder
    implements Builder<ProfileCreate, ProfileCreateBuilder> {
  _$ProfileCreate? _$v;
  ...
  ProfileCreateBuilder() {
    ProfileCreate._defaults(this);
  }

  ProfileCreateBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(ProfileCreate other) {
    _$v = other as _$ProfileCreate;
  }

  @override
  void update(void Function(ProfileCreateBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  ProfileCreate build() => _build();

  _$ProfileCreate _build() {
    final _$result = _$v ??
        _$ProfileCreate._(
          firstName: firstName,
