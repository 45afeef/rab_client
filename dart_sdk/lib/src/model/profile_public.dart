...
abstract class ProfilePublic implements Built<ProfilePublic, ProfilePublicBuilder> {
  ...
  factory ProfilePublic([void updates(ProfilePublicBuilder b)]) = _$ProfilePublic;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ProfilePublicBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<ProfilePublic> get serializer => _$ProfilePublicSerializer();
}

class _$ProfilePublicSerializer implements PrimitiveSerializer<ProfilePublic> {
  @override
  final Iterable<Type> types = const [ProfilePublic, _$ProfilePublic];

  @override
  final String wireName = r'ProfilePublic';
  ...
  void _deserializeProperties(
    ...
    required ProfilePublicBuilder result,
  ...
  @override
  ProfilePublic deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = ProfilePublicBuilder();
