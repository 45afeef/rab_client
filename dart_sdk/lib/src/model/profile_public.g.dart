...
part of 'profile_public.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$ProfilePublic extends ProfilePublic {
  @override
  ...
  @override
  ProfilePublicBuilder toBuilder() => ProfilePublicBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is ProfilePublic &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'ProfilePublic')
...
class ProfilePublicBuilder
    implements Builder<ProfilePublic, ProfilePublicBuilder> {
  _$ProfilePublic? _$v;
  ...
  ProfilePublicBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(ProfilePublic other) {
    _$v = other as _$ProfilePublic;
  }

  @override
  void update(void Function(ProfilePublicBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  ProfilePublic build() => _build();

  _$ProfilePublic _build() {
    final _$result = _$v ??
        _$ProfilePublic._(
          firstName: firstName,
