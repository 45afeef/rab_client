...
> UnitsList providersStayListStayUnits(providerId, minPrice, maxPrice, paxCount, amenities, limit, offset)
...
final int paxCount = 56; // int | 
final BuiltList<String> amenities = ; // BuiltList<String> | 
final int limit = 56; // int | 
final int offset = 56; // int | 

try {
    final response = api.providersStayListStayUnits(providerId, minPrice, maxPrice, paxCount, amenities, limit, offset);
    print(response);
} on DioException catch (e) {
